...
import main.java.com.walletapi.controllers.handlers.wallet.WalletHandler;
...
public class WalletController {
    ...
    public static void initializeRoutes(HttpServer server) {
        ...
        server.createContext("/all-wallets", new WalletHandler(ResourceManager.getWalletService()));
